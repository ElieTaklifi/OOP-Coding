...
Diff::Diff(shared_ptr<Function> func1, shared_ptr<Function> func2)
{
	m_func1 = func1;
	m_func2 = func2;
}

string Diff::printName()
{
...
string Diff::printHatsava(std::vector<int>& left, std::vector<int>& right)
{
...
vector<int> Diff::eval(std::vector<int>& left, std::vector<int>& right)
{
