...
Uni::Uni(shared_ptr<Function> func1, shared_ptr<Function> func2)
{
	m_func1 = func1;
	m_func2 = func2;
}

string Uni::printName()
{
	return "(" + m_func1->printName() + " U " + m_func2->printName() + ")";
}
...
string Uni::printHatsava(std::vector<int>& left, std::vector<int>& right)
{
...
vector<int> Uni::eval(std::vector<int>& left, std::vector<int>& right)
{
